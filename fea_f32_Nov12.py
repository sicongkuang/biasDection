...
def filter_col8_punctuation_number():
    ...
    with open('../../splitdata_Nov13_2015/test_afterdataclean_modifiedcleanedTuple_splitTitleNumBW_Nov13.json') as f:
    ...
    with open('../../stripPuncNumber_Nov16_2015/test_afterdataclean_modifiedcleanedTuple_splitTitleNumBW_stripPuncNum_Nov16.json','w') as t:
