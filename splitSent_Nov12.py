...
def splitCol8toWords(): 
    ...
    fres = open('../../splitdata_Nov13_2015/train_afterdataclean_modifiedcleanedTuple_splitTitleNumBW_Nov13.txt','w')
    ...
    ## record new dataset
    with open('../../splitdata_Nov13_2015/train_afterdataclean_modifiedcleanedTuple_splitTitleNumBW_Nov13.json','w') as f:
