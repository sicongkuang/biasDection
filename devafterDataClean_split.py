...
def dataReduce_afterdataclean1975():
    ...
    tupleSet =  open('../../devDataclean_Dec8_2015/devdataclean_col4True_col7singleBiaW_col9NotEmp_biasWordNotinTit_col7col8NotdifHyperL_col8within5_col7col8editDisGreat4_noStopWord_ProcBrack_Dec8.txt','r')
    newTupSet = []
    dfile = open('../../devDataclean_Dec8_2015/dev_afterdataclean_modifiedcleanedTupleDec9.txt','w')
    ...
    with open('../../devDataclean_Dec8_2015/dev_afterdataclean_modifiedcleanedTupleDec9.json','w') as o:
